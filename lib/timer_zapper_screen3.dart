...
class TimerZapperScreen3 extends ConsumerWidget {
  const TimerZapperScreen3({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final bool modoSeleccionado = ref.watch(selectModoProvider);
    final timer = ref.watch(countdownProvider3);
    ...
    final TerapiaTotal terapia = ref.watch(terapiaProvider3);

    const String location = '/timerZapper3';
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(
                              ...
                              fit: BoxFit.fill,
                              image: AssetImage(
                                  bluetoothProvider.bleServicesBatery[2]))),
                    )
                  ],
                ),
                body: Container(
