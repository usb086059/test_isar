...
void _terapiaSerialize(
  ...
  writer.writeLong(offsets[0], object.frecMax);
  writer.writeLong(offsets[1], object.frecMin);
...
Terapia _terapiaDeserialize(
  ...
  final object = Terapia(
    frecMax: reader.readLongOrNull(offsets[0]) ?? 0,
    frecMin: reader.readLongOrNull(offsets[1]) ?? 0,
