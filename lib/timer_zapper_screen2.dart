...
class TimerZapperScreen2 extends ConsumerWidget {
  const TimerZapperScreen2({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final bool modoSeleccionado = ref.watch(selectModoProvider);
    final timer = ref.watch(countdownProvider2);
    ...
    const String location = '/timerZapper2';
    ...
    return PopScope(
      ...
      onPopInvoked: (didPop) async {
        if (didPop) {
          return;
        } else if (ref.watch(countdownProvider2).estado == 'FIN') {
            ...
            ClipPath(
              ...
              child: Container(
                decoration: BoxDecoration(
                    gradient:
                        ref.watch(countdownProvider2).estado.contains('Ciclo')
                            ? azulGradientCurvas()
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            ...
                            fit: BoxFit.fill,
                            image: AssetImage(
                                bluetoothProvider.bleServicesBatery[1]))),
                  )
                ],
              ),
              body: Container(
                        ...
                        Container(
                            ...
                            child: Stack(
                              children: [
                                Center(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(ref.watch(countdownProvider2).estado,
                                          style: const TextStyle(
                                              fontSize: 25,
                                              fontWeight: FontWeight.bold),
                                ...
                                Visibility(
                                  visible:
                                      ref.watch(countdownProvider2).estado ==
                                              'FIN'
                                          ? true
                                          : false,
                                  child: Center(
